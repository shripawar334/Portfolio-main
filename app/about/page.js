        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-start">
          ...
          >
            ...
            <motion.p
              ...
              variants={itemVariants}
            >
              Computer Science student skilled in Java, Python, React, and Next.js with hands-on experience in web
              development and data science. Skilled in applying machine learning models using Pandas and Scikit-learn.
              Passionate about learning new technologies and building practical, data-driven solutions
            </motion.p>
